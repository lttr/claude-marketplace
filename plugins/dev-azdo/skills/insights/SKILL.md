---
name: insights
description: Generate codebase activity summaries (daily/weekly/catchup/view) from Azure DevOps PRs, work items, local git, and optionally Confluence. Trigger when user says "/dev-azdo:insights", asks "what happened", "codebase activity", "team summary", or wants a PR/commit roll-up.
---
