...
Plugins: **nuxt**, **video-to-article**, **dev-azdo** (Azure DevOps), **cc** (Claude Code authoring), **aiwork** (.aiwork/ protocol and the triage, spec, tickets, implement, review skills), **browser** (playwright-cli-based browser automation: playwright-cli, showme, page-bridge, pick), **maintenance** (docs-checker, dependency-update).
