...
Plugins: **nuxt**, **video-to-article**, **dev-azdo** (Azure DevOps), **cc** (Claude Code authoring), **aiwork** (.aiwork/ protocol and the triage, spec, tickets, implement, review skills), **browser** (agent-browser-based browser automation: agent-browser, showme, page-bridge, pick).
